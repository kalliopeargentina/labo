...
PARAM  <- list()
PARAM$experimento <- "07_E_FE_UmbSigma75Neg"

PARAM$exp_input  <- "07_E_DR_UmbSigma75Neg"
...
CanaritosAsesinos  <- function( canaritos_ratio=0.2 )
{
  ...
  umbral  <- tb_importancia[ Feature %like% "canarito", median(pos) - 0.75*sd(pos) ]  #Atencion corto en la mediana mas DOS desvios!!
